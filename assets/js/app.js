...
movieArray.forEach(movie => {
 if(movie.vote_average>=0 && movie.vote_average <=5)
 {
...
<img class="movieImg" src="https://image.tmdb.org/t/p/w1280/${movie.backdrop_path}" alt="img" title="img">
<figcaption>
...
<div class="col-2 align-self-center p-0" Style=>
<span class=${voteAverageColor}>${movie.vote_average}</span>
</div>	
</div>
</div>
<div class="overview">
